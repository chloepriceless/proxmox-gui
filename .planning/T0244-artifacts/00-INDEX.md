...
- **Round-9-Bestätigungs-Lens (Schnüffi):** ausstehend (gepingt). **R9 = BUILD-READY-Runde** auf der netns/Prozess-Schicht; danach Schnüffi-MED-6-RPC-Co-Gate (dritter Oracle). Trend R3:10→R8:2H.
