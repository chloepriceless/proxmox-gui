...
- **Round-8-Bestätigungs-Lens (Schnüffi):** ausstehend (gepingt). **R8 = realistischer BUILD-READY-Kandidat** auf der netns/Prozess-Schicht; danach Schnüffi-MED-6-RPC-Co-Gate. Trend R3:10→R7:3H+1M.
