...
- **Schnüffi-Co-Gate jetzt AKTIV (von gated):** zieht den 3. Oracle (`zone-selftest-broker`: Detektor-Recall Seed-PII→100%-Block + Broker-RPC-Cert-Pin für den daddr-losen :443) auf Artefakt-Niveau nach. Integrationspunkt in §6 verankert (GATE 3, Spawner Requires alle 3 Gates). Finale netns-Topo-Werte an Schnüffi geliefert.
