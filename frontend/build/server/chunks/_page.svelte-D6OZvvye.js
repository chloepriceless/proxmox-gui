...
function Sparkline($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    const polyline = derived(() => points.length === 0 ? "" : points.map((v, i) => {
    ...
    if (points.length === 0) {
      ...
      $$renderer2.push("<!--[-1-->");
      $$renderer2.push(`<svg${attr("viewBox", `0 0 ${W} ${H()}`)} preserveAspectRatio="none" role="img"${attr("aria-label", label)}${attr_class(`block w-full text-primary ${stringify(className)}`)}${attr_style(`height: ${H()}px;`)}><polyline fill="none" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round" stroke-linecap="round"${attr("points", polyline())}></polyline></svg>`);
    }
    $$renderer2.push(`<!--]-->`);
  });
}
                ...
                children: ($$renderer4) => {
                  ...
                  if (Card) {
                    ...
                    Card($$renderer4, {
                      class: "p-6",
                      children: ($$renderer5) => {
                        $$renderer5.push(`<h3 class="text-[13px] font-medium text-muted-foreground mb-3">Specs</h3> <dl class="grid grid-cols-[120px_1fr] gap-y-2 text-[13px]"><dt class="text-muted-foreground">Status</dt> <dd class="font-mono">${escape_html(detail().status)}</dd> <dt class="text-muted-foreground">vCPU</dt> <dd class="font-mono">${escape_html(detail().maxcpu)}</dd> <dt class="text-muted-foreground">RAM</dt> <dd class="font-mono">${escape_html(ramGb())} GB</dd> <dt class="text-muted-foreground">Disk</dt> <dd class="font-mono">${escape_html(diskGb())} GB</dd> <dt class="text-muted-foreground">Uptime</dt> <dd class="font-mono">${escape_html(detail().uptime)}s</dd> <dt class="text-muted-foreground">Type</dt> <dd class="font-mono">${escape_html(detail().type === "lxc" ? "LXC" : "VM (QEMU)")}</dd></dl>`);
                      },
                      $$slots: { default: true }
                    });
                    $$renderer4.push("<!--]-->");
                  ...
                  if (Card) {
                    ...
                    Card($$renderer4, {
                      class: "p-6",
                      children: ($$renderer5) => {
                        $$renderer5.push(`<h3 class="text-[13px] font-medium text-muted-foreground mb-3">Network</h3> <dl class="grid grid-cols-[120px_1fr] gap-y-2 text-[13px]"><dt class="text-muted-foreground">Node</dt> <dd class="font-mono">${escape_html(detail().node)}</dd> <dt class="text-muted-foreground">net0</dt> <dd class="font-mono truncate">${escape_html(String(detail().raw_config?.net0 ?? "—"))}</dd> <dt class="text-muted-foreground">net1</dt> <dd class="font-mono truncate">${escape_html(String(detail().raw_config?.net1 ?? "—"))}</dd> <dt class="text-muted-foreground">Net in</dt> <dd class="font-mono">${escape_html((detail().netin / 1024).toFixed(1))} KB/s</dd> <dt class="text-muted-foreground">Net out</dt> <dd class="font-mono">${escape_html((detail().netout / 1024).toFixed(1))} KB/s</dd></dl>`);
                      },
                      $$slots: { default: true }
                    });
                    $$renderer4.push("<!--]-->");
...
//# sourceMappingURL=_page.svelte-D6OZvvye.js.map
