import { x as run, aB as head, c as escape_html, k as attr, j as ensure_array_like, d as derived } from './renderer-mZFfBJIU.js';
...
import { A as Arrow_left } from './arrow-left-BH41CkGU.js';
...
import './alert-description-AZYCkEvU.js';
import './alert-dialog-description-C3hFoiPT.js';
import './dialog-description2-DYXaekbV.js';
import './shield-alert-CbGtd534.js';
import './clock-6Ru2SlY1.js';
    ...
    function $$render_inner($$renderer3) {
      ...
      if (Card) {
        ...
        the stored value.`);
            ...
            Users select retention; they do not pick storage.</p> `);
                  {
                    $$renderer5.push("<!--[-1-->");
                  }
                  $$renderer5.push(`<!--]--></div> <div class="flex flex-row items-start gap-2 rounded-md border border-border p-3">`);
                  Checkbox($$renderer5, {
...
//# sourceMappingURL=_page.svelte-Dy-DK9FU.js.map
